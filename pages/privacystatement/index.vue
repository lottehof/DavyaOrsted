<template lang="html">
  <section class="privacystatement">
    <div class="title-privacystatement">
      <h1 class="title">{{ story.content.title}}</h1>
    </div>
    <section class="privacystatement-content" v-html="$options.filters.markdown(story.content.content)"></section>
  </section>
...
export default {
    ...
    return context.app.$storyapi.get('cdn/stories/privacystatement', {
